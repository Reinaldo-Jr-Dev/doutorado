...
- **Breve descrição**: Um conjunto de testes mais equilibrado é essencial para a obtenção de maior eficácia na localização de defeitos em software. Nesse contexto, o presente artigo propõe uma comparação entre a técnica de balanceamento SMOTE, em sua versão canônica, e técnicas de balanceamento derivadas do SMOTE, tais como SMOTENC, SMOTEN, ADASYN, Borderline-SMOTE, KMeans-SMOTE e SVM-SMOTE. A investigação tem como objetivo avaliar a métrica Pos-Fault sobre as novas matrizes de casos de teste geradas pela aplicação de cada técnica de balanceamento ao benchmark Defects4J, considerando as seguintes heurísticas de localização de defeitos: Ochiai, Tarantula, Jaccard, OP2, Barinel e DStar. Adicionalmente, a fim de conferir maior robustez à análise dos dados experimentais, serão empregados os testes estatísticos de Wilcoxon Signed-Rank e Vargha & Delaney.

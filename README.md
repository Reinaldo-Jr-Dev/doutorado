...
# Baseline
- Dados (matriz de espectro) sem a aplicação do balanceamento de dados e dados balanceados (SMOTE - Synthetic Minority Over-Sampling Technique) [45].
...
- Pontos a serem destacados para cada métrica:
  ...
  - RIMP: a mesma obteve um melhor resultado ao aplicar a técnica de balencamento de dados, apenas para a heurísticas Tarantula e para o projeto Chart.
